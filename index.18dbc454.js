...
var _appendImagesMarkupJs = require("./appendImagesMarkup.js");
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
// Add images
(0, _refsJs.refs).loadMoreBtn.addEventListener("click", onLoadMoreBtn);
function onLoadMoreBtn() {
    (0, _appendImagesMarkupJs.appendImagesMarkup)();
    macyInstance.runOnImageLoad(()=>macyInstance.recalculate(true), true);
    lightbox.refresh();
    (0, _refsJs.refs).loadMoreBtn.classList.add("hidden");
    (0, _refsJs.refs).gradient.classList.add("hidden");
}
// Siema
const mySiema = new Siema({
    selector: (0, _refsJs.refs).slider,
    duration: 1000,
    easing: "cubic-bezier(.17,.67,.32,1.34)",
    loop: true,
    onInit: ()=>{
        console.log("Siema work!");
    }
});
(0, _refsJs.refs).prev.addEventListener("click", ()=>mySiema.prev(), {
    passive: true
});
(0, _refsJs.refs).next.addEventListener("click", ()=>mySiema.next(), {
    passive: true
});
// AOS
AOS.init();
...
const macyInstance = Macy({
    container: (0, _refsJs.refs).gallery,
    columns: 3,
    margin: 44,
    trueOrder: true,
    breakAt: {
...
// Mobile menu
(0, _refsJs.refs).mobMenuBtn.addEventListener("click", toggleMenu);
function toggleMenu() {
    (0, _refsJs.refs).mobMenuBtn.classList.toggle("is-active");
    (0, _refsJs.refs).mobMenu.classList.toggle("is-active");
}
// Header scroll
window.onscroll = ()=>changeHeaderBackground();
function changeHeaderBackground() {
    const headerOffsetTrigger = (0, _refsJs.refs).header.offsetTop;
    const pageOffset = window.pageYOffset;
    if (pageOffset > headerOffsetTrigger) (0, _refsJs.refs).header.classList.add("transparency");
    else (0, _refsJs.refs).header.classList.remove("transparency");
}
// Search input
(0, _refsJs.refs).searchOpen.addEventListener("click", onSearchOpen);
(0, _refsJs.refs).searchClose.addEventListener("click", onSearchClose);
(0, _refsJs.refs).input.addEventListener("input", (0, _lodashDefault.default).debounce(onInputChange, 300));
function onSearchOpen() {
    (0, _refsJs.refs).searchForm.classList.add("is-active");
}
function onSearchClose() {
    (0, _refsJs.refs).searchForm.classList.remove("is-active");
}
function onInputChange(e) {
    const text = (0, _refsJs.refs).input?.value.trim().toLowerCase();
    console.log(text, "seach text");
    const elements = document.querySelectorAll("p, h1, h2, h3, h4, span, a");
    for(let i = 0; i < elements.length; i++){
        const element = elements[i];
        if (element.innerText?.toLowerCase().includes(text)) element.classList.add("highlight");
        if (text === "") element.classList.remove("highlight");
    }
}

},{"./refs.js":"2WoF2","./appendImagesMarkup.js":"1yQZ8","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2WoF2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"1yQZ8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "appendImagesMarkup", ()=>appendImagesMarkup);
...
const appendImagesMarkup = ()=>{
    (0, _refs.refs).gallery.insertAdjacentHTML("beforeend", markup);
};

},{"./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}]},["46McK","1SICI"], "1SICI", "parcelRequire4357")
